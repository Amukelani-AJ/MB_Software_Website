        ...
        <div style={{ position: "relative", marginRight: "4px" }}>
          <button
            ...
            style={{
              ...
              borderRadius: "8px",
              border: `1px solid ${isAttorney ? "rgba(96,165,250,0.35)" : "rgba(141,198,63,0.35)"}`,
          ...
          {roleOpen && (
            ...
            >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: "12px 14px",
                      border: "none",
                      background: active ? `${role.color}10` : "transparent",
                      cursor: "pointer",
                      textAlign: "left",
              ...
              >
                ...
                >
                  {isAttorney
                    ? "⚡ Attorney view: Activity Feed focused"
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                {activeRole.label.split(" ")[0]}
              </p>
              <p
                style={{
                  fontSize: "10px",
                  color: `${activeRole.color}99`,
                  margin: 0,
                  letterSpacing: "0.5px",
                }}
              >
